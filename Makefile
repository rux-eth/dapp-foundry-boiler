...
# Install the Modules
install :; forge install dapphub/ds-test && forge install rari-capital/solmate && forge install foundry-rs/forge-std && forge install ZeframLou/clones-with-immutable-args && forge install OpenZeppelin/openzeppelin-contracts
